...
# Python 3.13 removed imghdr from stdlib — install the backport via requirements.txt
# and import it here before python-telegram-bot loads, so it can find the module.
try:
    import imghdr
except ImportError:
    raise RuntimeError(
        "Missing 'imghdr' module. Add 'imghdr==0.0.1' to requirements.txt "
        "and redeploy. (Removed from Python 3.13 stdlib.)"
    )
